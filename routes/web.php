...
Route::controller(BannerController::class)->middleware('auth')->group(function () {
    Route::get('banner-promo', 'index')->name('banner');
    Route::post('banner-promo', 'store')->name('banner.store');
    Route::get('update/banner-promo/{id}', 'edit')->name('banner.edit');
    Route::post('update/banner-promo/{id}', 'update')->name('banner.update');
    Route::post('delete/banner-promo/{id}', 'destroy')->name('banner.destroy');
});
Route::controller(Banner2Controller::class)->middleware('auth')->group(function() {
    Route::post('banner-promo2', 'store')->name('banner2.store');
    Route::get('update/banner-promo2/{id}', 'edit')->name('banner2.edit');
    Route::post('update/banner-promo2/{id}', 'update')->name('banner2.update');
    Route::post('delete/banner-promo2/{id}', 'destroy')->name('banner2.destroy');
});
